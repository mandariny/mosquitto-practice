...
public class MqttConfig {
    private static final String MQTT_USERNAME = "web_server";
    private static final String MQTT_PASSWORD = "1234";

    private static final String BROKER_URL = "tcp://localhost:1883";
    private static final String[] URLS = {BROKER_URL};
    ...
    private static final String TOPIC_FILTER = "test_mqtt";
